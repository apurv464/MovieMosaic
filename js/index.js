...
(function () {
  ...
  searchKeyword.addEventListener("keyup", function () {
    ...
    if (search === "") {
      superContainer.style.backgroundImage = "url('/images/movies-image.jpg')";
      suggestionsContainer.innerHTML = "";
      // clears the previous movies from array
      suggestionList = [];
    } else {
      superContainer.style.backgroundImage = "linear-gradient(315deg, #7a7adb 0%, #170e13 74%)";
      // superContainer.style.background = "#7a7adb";
      (async () => {
